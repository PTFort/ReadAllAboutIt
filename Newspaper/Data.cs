...
namespace Newspaper
{
    public class Data
    {
		...
		public static string[] otherArticles = new string[] { "Spotlight on traffic: pg. <INT>", "Driving advice: pg. <INT>", "How's Your Driving?: pg. <INT>", "<CITYNAME>'s Best Restaurants: pg. <INT>", "Spotlight on <DISTRICT>", "<CITYNAME> Budget Issues: pg. <INT>", "Inside: Does Mayor have too much power?",
