...
namespace Newspaper
{
    public class Data
    {
        ...
        public static string[] templates = new string[]
        {
            ...
            "New <CITIZEN-X-PLURAL-CAP> in <CITYNAME> = You might have noticed a few more neighbours on your <ROAD>. Since last week, there's been a <LARGE> <ADJECTIVE> wave of people who have moved into <CITYNAME>, and are looking for a <ADJECTIVE> place to call home. One <CITIZEN>, <FIRSTNAME> <LASTNAME>, <SAID>, \"I love <CITYNAME>. It's so <ADJECTIVE>, not to mention <LARGE>. My old town of East Acres was very tiny, and had no room for expansion. How could anyone live like that?\".",
        ...
        public static string[] citizenTerms = new string[] { "pleb", "peasant", "citizen", "local", "resident", "denizen", "burgher", "commoner", "inhabitant", "subject" };
        ...
        public static string[] moveTerms = new string[] { "move", "scramble", "run", "jog", "progress", "advance", "relocate", "budge", "circulate" };
    
        public static string[] reporters = new string[] {"Peter T. Forte", "Todd A. LeMou", "Ned Light", "Tim Bow", "M.A. Bacco", "Flynn S. Mann"};
    }
}
